...
class Twitter(modules.ThreadedModule):
    ...
    def configure(self, parent):
        ...
        if self.cfgWindow is None:
            self.cfgWindow = Window('Twitter.ui', 'vbox1', __name__, _(MOD_INFO[modules.MODINFO_NAME]), 440, 141)
            # GTK handlers
    ...
    def onBtnHelp(self, btn):
        ...
        helpDlg = HelpDlg(_(MOD_INFO[modules.MODINFO_NAME]))
