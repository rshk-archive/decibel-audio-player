...
class Tracklist(modules.Module):
    ...
    def showPopupMenu(self, list, path, button, time):
        ...
        repeat.set_active(prefs.get(__name__, 'repeat-status', PREFS_DEFAULT_REPEAT_STATUS))
    ...
    def onAppStarted(self):
        ...
        visible = prefs.get(__name__, 'columns-visibility-2', PREFS_DEFAULT_COLUMNS_VISIBILITY)
        ...
        # Restore preferences
        self.btnRepeat.set_active(prefs.get(__name__, 'repeat-status', PREFS_DEFAULT_REPEAT_STATUS))
        # Set icons
    ...
    def onButtonRepeat(self, btn):
        ...
        prefs.set(__name__, 'repeat-status', self.btnRepeat.get_active())
    ...
    def onColumnVisibilityChanged(self, list, colTitle, visible):
        ...
        visibility = prefs.get(__name__, 'columns-visibility-2', PREFS_DEFAULT_COLUMNS_VISIBILITY)
        visibility[colId] = visible
        prefs.set(__name__, 'columns-visibility-2', visibility)
