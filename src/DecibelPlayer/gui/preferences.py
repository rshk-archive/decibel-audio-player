...
import gtk
from .. import gui, modules, tools
from ..tools   import consts, icons


ROW_ENABLED = 0    # True if the module is currently enabled
ROW_TEXT = 1       # Name and description of the module
ROW_ICON = 2       # An icon indicating whether the module is configurable
ROW_UNLOADABLE = 3 # True if the module can be disabled
ROW_INSTANCE = 4   # Instance of the module, if any
ROW_MODINFO = 5    # Information exported by a module
